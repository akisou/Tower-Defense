...
{
    // 创建一直播放的背景音乐::fromLocalFile(s_curDir +
    QUrl backgroundMusicUrl = QUrl("C:/Users/HP/Desktop/programing/taoranai/towerdefense(on-constructing)/music/8bitDungeonLevel.mp3");
...
void AudioPlayer::playSound(SoundType soundType)
{
	...
	{
        QUrl(":/music/tower_place.wav"),
        QUrl(":/music/life_lose.wav"),
        QUrl(":/music/laser_shoot.wav"),
        QUrl(":/music/enemy_destroy.wav")
	};
...
void AudioPlayer::changeVolumn(int value){
    this->m_backgroundMusic->volumeChanged(value);
}
